...
module.exports = {
	...
	encodeData: function (image, options) {
		...
		if (options.physical) {
			...
			if (options.physical.xPixelPerUnit !== undefined) {
				chunk.setXPixelPerUnit(options.physical.xPixelPerUnit);
			}
			if (options.physical.yPixelPerUnit !== undefined) {
				chunk.setYPixelPerUnit(options.physical.yPixelPerUnit);
			}
			if (options.physical.unit !== undefined) {
				chunk.setUnit(options.physical.unit);
			}
