...
/**
 * Scale factor for 1-to-8-bit value conversion
 *
 * @static
 * @property SCALE_FACTOR_1_TO_8_BIT
 * @type {number}
 */
Scale.SCALE_FACTOR_1_TO_8_BIT = 255;

/**
 * Scale factor for 8-to-1-bit value conversion
 *
 * @static
 * @property SCALE_FACTOR_8_TO_1_BIT
 * @type {number}
 */
Scale.SCALE_FACTOR_8_TO_1_BIT = 1 / 255;

/**
 * Scale factor for 2-to-8-bit value conversion
 *
 * @static
 * @property SCALE_FACTOR_2_TO_8_BIT
 * @type {number}
 */
Scale.SCALE_FACTOR_2_TO_8_BIT = 255 / 3;

/**
 * Scale factor for 8-to-2-bit value conversion
 *
 * @static
 * @property SCALE_FACTOR_8_TO_2_BIT
 * @type {number}
 */
Scale.SCALE_FACTOR_8_TO_2_BIT = 3 / 255;

/**
 * Scale factor for 4-to-8-bit value conversion
 *
 * @static
 * @property SCALE_FACTOR_4_TO_8_BIT
 * @type {number}
 */
Scale.SCALE_FACTOR_4_TO_8_BIT = 255 / 15;

/**
 * Scale factor for 8-to-4-bit value conversion
 *
 * @static
 * @property SCALE_FACTOR_8_TO_4_BIT
 * @type {number}
 */
Scale.SCALE_FACTOR_8_TO_4_BIT = 15 / 255;

/**
 * Scale factor for 8-to-8-bit value conversion - identity
 *
 * @static
 * @property SCALE_FACTOR_8_TO_8_BIT
 * @type {number}
 */
Scale.SCALE_FACTOR_8_TO_8_BIT = 1;

/**
 * Scale factor for 16-to-8-bit value conversion
 *
 * @static
 * @property SCALE_FACTOR_16_TO_8_BIT
 * @type {number}
 */
Scale.SCALE_FACTOR_16_TO_8_BIT = 255 / 65535;

/**
 * Scale factor for 8-to-16-bit value conversion
 *
 * @static
 * @property SCALE_FACTOR_8_TO_16_BIT
 * @type {number}
 */
Scale.SCALE_FACTOR_8_TO_16_BIT = 65535 / 255;
...
Scale.prototype._scale1to8bit = function (isIndexedColor, paddingAt) {
	...
	var scaleFactor = isIndexedColor ? 1 : Scale.SCALE_FACTOR_1_TO_8_BIT,
		byteCounter = 0;
...
Scale.prototype._scale2to8bit = function (isIndexedColor, paddingAt) {
	...
	var scaleFactor = isIndexedColor ? 1 : Scale.SCALE_FACTOR_2_TO_8_BIT,
		byteCounter = 0;
...
Scale.prototype._scale4to8bit = function (isIndexedColor, paddingAt) {
	...
	var scaleFactor = isIndexedColor ? 1 : Scale.SCALE_FACTOR_4_TO_8_BIT,
		byteCounter = 0;
...
Scale.prototype._scale16to8bit = function (isIndexedColor) {
	...
	var scaleFactor = isIndexedColor ? 1 : Scale.SCALE_FACTOR_16_TO_8_BIT;
...
/**
 * Scales a value according to header
 *
 * @method scaleInValue
 * @param {number} value
 * @return {number}
 */
Scale.prototype.scaleInValue = function (value) {
	...
	switch(bitDepth) {
		...
		case 1:
			result = value * Scale.SCALE_FACTOR_1_TO_8_BIT;
			break;

		case 2:
			result = value * Scale.SCALE_FACTOR_2_TO_8_BIT;
			break;

		case 4:
			result = value * Scale.SCALE_FACTOR_4_TO_8_BIT;
			break;

		case 8:
			result = value * Scale.SCALE_FACTOR_8_TO_8_BIT;
			break;

		case 16:
			result = value * Scale.SCALE_FACTOR_16_TO_8_BIT;
			break;
	}
 ...
 * Scales a value according to header
 *
 * @method scaleOutValue
 * @param {number} value
 * @return {number}
 */
Scale.prototype.scaleOutValue = function (value) {
	...
	switch(bitDepth) {
		...
		case 1:
			result = value * Scale.SCALE_FACTOR_8_TO_1_BIT;
			break;

		case 2:
			result = value * Scale.SCALE_FACTOR_8_TO_2_BIT;
			break;

		case 4:
			result = value * Scale.SCALE_FACTOR_8_TO_4_BIT;
			break;
		...
		case 16:
			result = value * Scale.SCALE_FACTOR_8_TO_16_BIT;
			break;
	}
