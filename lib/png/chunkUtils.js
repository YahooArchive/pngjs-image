...
module.exports = {
	 ...
	 * @param {boolean} required Is retrieval of chunks required?
	 * @return {Chunk[]|null}
	 */
	...
	getChunkTypes: function () {
		...
		for(var chunkType in this._chunks) {
			if (this._chunks.hasOwnProperty(chunkType)) {
	 ...
	 */
	applyWithSortedChunks: function (fn, reverse) {
		var chunks;
